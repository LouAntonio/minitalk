...
$(NAME): $(OBJS_NAME1) $(OBJS_NAME2) $(FTPRINTF)
...
bonus: $(OBJS_NAME1_BONUS) $(OBJS_NAME2_BONUS) $(FTPRINTF)
		${CC} ${FLAGS} ${OBJS_NAME1_BONUS} $(FTPRINTF) -o ${NAME1}
		${CC} ${FLAGS} ${OBJS_NAME2_BONUS} $(FTPRINTF) -o ${NAME2}
